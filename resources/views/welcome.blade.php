    ...
    <div
        ...
        <main class="flex max-w-[335px] w-full flex-col-reverse lg:max-w-4xl lg:flex-row">
            <div
                ...
                <h1 class="mb-1 font-medium">Perpus App</h1>
                <p class="mb-2 text-[#706f6c] dark:text-[#A1A09A]">Sistem manajemen perpustakaan modern untuk mengelola
                    buku, anggota, peminjaman, pengembalian, denda, dan aktivitas operasional.</p>
                <ul class="flex flex-col mb-4 lg:mb-6">
                    <li
                        ...
                        <span>Kelola koleksi buku, stok, dan peminjaman dengan lebih terstruktur.</span>
                    </li>
                    <li
                        ...
                        <span>Gunakan dashboard admin untuk memantau aktivitas perpustakaan secara real-time.</span>
                    </li>
                </ul>
